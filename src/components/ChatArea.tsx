...
export default function ChatArea() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full min-h-0">
      ...
      <div className="px-4 py-2.5 border-b border-dark-800/70 bg-dark-900/60 backdrop-blur-xl flex items-center justify-between shrink-0 gap-3">
        <div className="flex items-center gap-2.5 min-w-0">
          {/* Compact gradient icon */}
          <div
            className="relative w-8 h-8 rounded-lg cm-gradient-primary flex items-center justify-center shrink-0"
            ...
            <p className="text-[11px] text-dark-500 flex items-center gap-1.5">
              ...
              {activeConversation.projectPath && (
                <>
                  ...
                  <span className="truncate">{activeConversation.projectPath.split('/').pop()}</span>
                </>
              )}
            </p>
          </div>
      ...
      {/* Messages Container */}
      <div className="flex-1 overflow-y-auto overflow-x-hidden min-h-0 px-4 py-6 space-y-6 scroll-smooth">
        {activeConversation.messages.length === 0 ? (
